...
# Install packages
sudo pacman -Sy --noconfirm xorg-server libx11 libxft xorg-xinit xorg-xset xorg-xbacklight xorg-xrandr xorg-xsetroot gnome-keyring polkit-gnome feh lxappearance pcmanfm neovim tmux npm nodejs cbatticon network-manager-applet zsh-autosuggestions zsh-syntax-highlighting openfortivpn dunst pavucontrol flameshot alacritty redshift

cd /tmp
git clone https://aur.archlinux.org/yay-git.git
cd yay-git/;makepkg -si --noconfirm

yay -S noto-fonts nerd-fonts-noto xss-lock betterlockscreen xclip
